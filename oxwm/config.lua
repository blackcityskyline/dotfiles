...
-- Layout management
oxwm.key.bind({ modkey }, "Z", oxwm.layout.set("tiling"))
oxwm.key.bind({ modkey }, "X", oxwm.layout.set("floating"))
...
oxwm.autostart("xwallpaper --zoom ~/Pictures/wallpapers/3b32361168836b442693f36319bcfc23.jpg")
